...
import { Link } from 'react-router-dom'
  ...
  return (
    <div className="flex flex-col w-screen pt-28 px-16 text-gray-300 bg-zinc-900 pb-4 border-b-[.1px] border-b-gray-500/40 px-16 md:px-20 lg:px-24 xl:px-32 2xl:px-48">
